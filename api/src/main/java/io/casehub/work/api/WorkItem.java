...
public record WorkItem(
    ...
    public static final class Builder {
        ...
        public Builder formKey(String v) { this.formKey = v; return this; }
        public Builder status(WorkItemStatus v) { this.status = v; return this; }
        public Builder priority(WorkItemPriority v) { this.priority = v; return this; }
        public Builder assigneeId(String v) { this.assigneeId = v; return this; }
        public Builder owner(String v) { this.owner = v; return this; }
        public Builder candidateGroups(String v) { this.candidateGroups = v; return this; }
        public Builder candidateUsers(String v) { this.candidateUsers = v; return this; }
        public Builder requiredCapabilities(String v) { this.requiredCapabilities = v; return this; }
        public Builder createdBy(String v) { this.createdBy = v; return this; }
        public Builder delegationChain(String v) { this.delegationChain = v; return this; }
        public Builder delegationDeclineTarget(DeclineTarget v) { this.delegationDeclineTarget = v; return this; }
        public Builder priorStatus(WorkItemStatus v) { this.priorStatus = v; return this; }
        ...
        public Builder claimDeadline(Instant v) { this.claimDeadline = v; return this; }
        public Builder expiresAt(Instant v) { this.expiresAt = v; return this; }
        public Builder followUpDate(Instant v) { this.followUpDate = v; return this; }
        public Builder createdAt(Instant v) { this.createdAt = v; return this; }
        public Builder updatedAt(Instant v) { this.updatedAt = v; return this; }
        public Builder assignedAt(Instant v) { this.assignedAt = v; return this; }
        ...
        public Builder suspendedAt(Instant v) { this.suspendedAt = v; return this; }
        public Builder accumulatedUnclaimedSeconds(long v) { this.accumulatedUnclaimedSeconds = v; return this; }
        public Builder lastReturnedToPoolAt(Instant v) { this.lastReturnedToPoolAt = v; return this; }
        public Builder labels(List<WorkItemLabel> v) { this.labels = v; return this; }
        public Builder types(Set<String> v) { this.types = v; return this; }
        public Builder confidenceScore(Double v) { this.confidenceScore = v; return this; }
        public Builder callerRef(String v) { this.callerRef = v; return this; }
        public Builder parentId(UUID v) { this.parentId = v; return this; }
        public Builder scope(String v) { this.scope = v; return this; }
        public Builder templateId(UUID v) { this.templateId = v; return this; }
        public Builder templateVersion(Long v) { this.templateVersion = v; return this; }
        public Builder permittedOutcomes(String v) { this.permittedOutcomes = v; return this; }
        public Builder excludedUsers(String v) { this.excludedUsers = v; return this; }
        public Builder outcome(String v) { this.outcome = v; return this; }
        public Builder inputDataSchema(String v) { this.inputDataSchema = v; return this; }
        public Builder outputDataSchema(String v) { this.outputDataSchema = v; return this; }
        public Builder payloadTypeName(String v) { this.payloadTypeName = v; return this; }
