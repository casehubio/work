...
public class SlaDefaultsYamlLoader {
    ...
    volatile SlaDeclarativeConfig loadedConfig;
    ...
    public void reload() {
        SlaDeclarativeConfig refreshed = mergeConfigOverrides(loadFromClasspath());
        this.loadedConfig = refreshed;
        LOG.info("SLA defaults reloaded");
    }
    ...
    private BreachAction parseNodeAction(JsonNode node) {
        ...
        if (value instanceof String s) {
            return BreachAction.parse(WorkItemTemplateYamlLoader.resolveOrNull(s));
        }
